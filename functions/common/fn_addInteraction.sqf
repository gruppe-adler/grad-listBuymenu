...
params ["_object", "_baseConfigName", ["_cargospace", objNull], ["_vehiclespawn", objNull], ["_shopName", ""], ["_actionDescription", "Buy Gear"], ["_condition", {true}], ["_position",[0,0,0]], ["_distance",3], "_rootAction"];
...
},_condition,{},[_object,_cargospace,_vehiclespawn,_baseConfigName,_shopName],_position,_distance] call ace_interact_menu_fnc_createAction;
